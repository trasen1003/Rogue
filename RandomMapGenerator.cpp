    ...
    // PREMIERE SALLE : personnage present
            ...
            while (boolwhile)
            {
                ...
                if ((x+a-1< longueur_grille - 1 ) && (y + b - 1 < hauteur_grille- 1))
                {
                    ...
                    //mise du personnage 
                    IntMap[x + 1 + rand()%(a-2)][y + 1 + rand()%(b-2)] = 6;
                    boolwhile = false;
                }
                        ...
                        for (int k = x; k < x+a; k++)
                        {
                            for (int l = y; l< y +b; l++)
                            {
                                ...
                                else
                                {
                                    ...
                                    // monstre 
                                    if ( rand() / (RAND_MAX + 1.) < 6/(hauteur_grille * longueur_grille) )
                                        IntMap[k][l] = 7;
                                }
                                etat[k][l] = 1;
            ...
            while (boolwhile)
            {
                ...
                if ((x+a-1< longueur_grille - 1 ) && (y + b - 1 < hauteur_grille- 1))
                {
                    ...
                    if (test)
                    {
                        ...
                        IntMap[x + 1 + rand()%(a-2)][y + 1 + rand()%(b-2)] = 5;
...
int porte1[2] = {portes[1], portes[0]};
int porte2[2] = {portes[3], portes[2]};
cout << portes[0] << portes[1] << endl;
vector<vector<int>> l = find(porte1, porte2, etat);
for (int i = 0; i < l.size(); i++)
    IntMap[l[i][1]][l[i][0]] = 4;
...
int main(){
    vector<vector<int>> IntMap =  Generateur(2, 50, 50);
